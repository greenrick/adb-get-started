...
const related_path = "https://oracle.github.io/learning-library/common/related/";
// const related_path = "http://localhost:5500/common/related/";
    ...
    let setupTutorialNav = function(manifestFileContent) {
        ...
        $(manifestFileContent.tutorials).each(function(i, tutorial) {
            ...
            $(document.createElement('li')).each(function() {
                ...
                $(this).text(tutorial.title).wrapInner("<a style=\"" + this_style + "\" href=\"" + unescape(setParam(window.location.href, queryParam, getMDFileName(tutorial.filename))) + "\"><div></div></a>");
                $(this).appendTo(ul);
